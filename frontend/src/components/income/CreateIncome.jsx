...
import { useCreateUserIncomeMutation } from "../../redux/slices/incomeApiSlice";
...
const CreateIncomeContainer = styled(Stack)(({ theme }) => ({
...
export default function CreateIncome(props) {
  ...
  const [createIncome] = useCreateUserIncomeMutation();
  ...
  return (
    <AppTheme {...props}>
      ...
      <CreateIncomeContainer direction="column" justifyContent="space-between">
